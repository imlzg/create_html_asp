...
sub period()
	...
	"if(document.softmove.scid.options[document.softmove.scid.selectedindex].value == document.softmove.cid.options[document.softmove.cid.selectedindex].value){"&_
	"alert('同一个目录间不需要移动！');"&_
	"document.softmove.cid.focus();"&_
	"return false;"&_
	"}"&_
	"return true;"&_
	"}"&_
	...
	"<form name=softmove action=soft_move_all.asp method=post onSubmit='return CheckInput()'>"&_
	...
	call etime()
	Response.Write "</td></tr>"&_
	"<tr><td>原目录</td><td><select name=scid>"
	call catalist()
	Response.Write "</td></tr>"&_
	"<tr><td>目标目录</td><td><select name=cid>"
	call catalist()
	Response.Write "</td></tr>"&_
...
sub user()
	Response.Write "<table>"&_
	"<form name=softmove action=soft_move_all.asp method=post>"&_
	"<tr><td>用户</td><td>"
	call userlist()
	Response.Write "</td></tr>"&_
	"<tr><td>原目录</td><td><select name=scid>"
