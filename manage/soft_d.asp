...
sub period()
	...
	"<form name=softdelete action=soft_delete_all.asp method=post>"&_
	...
	call catalist()
	Response.Write "</td></tr>"&_
	"<tr><td></td><td><input name=button type=submit value=提　交>	<input name=onlyhtml type=checkbox value=1>只删除HTML</td></tr>"&_
	"<input name=act type=hidden value=period></form>"&_
	"</table>"

	Response.Write "<script LANGUAGE='JavaScript'>"&_
	"softdelete.newtime.click();"&_
